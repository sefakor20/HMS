...
if (isset($_POST['submit'])) {
    ...
    if ($old_password === $password_to_compare) {
        ...
        if ($password === $confirm_password) {
            ...
            $query = "UPDATE user SET first_name = '$first_name', middle_name = '$middle_name', last_name = '$last_name', email = '$email', username = '$username', phone = '$phone', password = '$password', updated_at = NOW() WHERE user.id = '$id' ";
