...
$total = getStudentApprovedReservationTotal($connection, $_SESSION['student']);
...
$offset = ($page - 1) * $rows;
$approved =  getStudentAllApprovedReservation($connection, $_SESSION['student'], $rows, $offset);
...
<head>
    ...
    <title>Student - All Approved</title>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">All Approved</h3>
                        </div>
